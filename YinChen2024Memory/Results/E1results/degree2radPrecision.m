...
for i=1:168
    if ConResults(i,3) == 1
        if ConResults(i,3) == ConResults(i,1)
            selfTarg(a1,1) = ConResults(i,8);
            selfResp(a1,1) = ConResults(i,10);
            a1=a1+1;
        else
    ...
    elseif ConResults(i,3) == 2
        if ConResults(i,3) == ConResults(i,1)
            friendTarg(a2,1) = ConResults(i,8);
            friendResp(a2,1) = ConResults(i,10);
            a2=a2+1;
        else
    ...
    elseif ConResults(i,3) == 3
        if ConResults(i,3) == ConResults(i,1)
            strangerTarg(a3,1) = ConResults(i,8);
            strangerResp(a3,1) = ConResults(i,10);
            a3=a3+1;
        else
